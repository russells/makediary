...
# $Id: makediary,v 1.138 2002/12/20 01:13:23 russells Exp $
    ...
    def parseOptions(self):
        ...
        for opt in optlist:
            if opt[0] == '--year':
                ...
                print "Version $Id: makediary,v 1.138 2002/12/20 01:13:23 russells Exp $"
                sys.exit(0)
            else:
...
class VersionPage(PostscriptPage):
    def body(self):
        ...
        versionString = self.postscriptEscape(
            "Version: $Id: makediary,v 1.138 2002/12/20 01:13:23 russells Exp $")
...
class Diary:
    ...
    def preamble(self):
        ...
        p = p + "%%BeginProlog\n" \
            ...
            (self.di.myname,"$Id: makediary,v 1.138 2002/12/20 01:13:23 russells Exp $") \
