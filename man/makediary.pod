...
Monday to Wednesday, and on the right side, Thursday to Sunday.
...
Friday, and Saturday and Sunday.  In both layouts, the same day always appears
in the same position on the same page.
