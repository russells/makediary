...
Prints PostScript code for an A5 diary.  Can include events printed on
dates specified in a F<.calendar> file.  The F<.calendar> file is in the
same format as used bypcal(1), with some extensions.
...
=head2 Two pages on letter paper

Two pages per letter paper sheet:
...
$Id: makediary.pod 46 2002-12-31 17:01:45Z anonymous $
